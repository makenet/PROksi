...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
	...
	<body <?php body_class() ?> id="bp-default">
		...
		<div style="display:none;"><?php printf(utf8_encode('Metropolia Ammattikorkeakoulun uusi projektiympäristö, jossa opiskelija, opettaja ja työelämä kohtaavat.'));?></div>
		<div id="header">
