		...
		<div class="page" id="register-page">
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<div class="register-section" id="basic-details-section">
                    ...
                    <div style="margin-top:20px;padding:10px 0;border-top:1px solid #ccc;border-bottom:1px solid #ccc;display:block;">
                        <h4><?php _e( 'Account Details', 'buddypress' ) ?></h4>
                        
                        
    
                        <label for="signup_username"><?php _e( 'Kirjautumisnimi', 'buddypress' ) ?> <?php _e( '(required)', 'buddypress' ) ?></label>
                        <?php do_action( 'bp_signup_username_errors' ) ?>
                        <input type="text" name="signup_username" id="signup_username" value="<?php bp_signup_username_value() ?>" />
                        <small><i>Sisäänkirjautumisessa käytettävä käyttäjänimi. Vain pieniä kirjaimia ilman välilyöntejä</i></small>
                       
                        <label for="signup_email"><?php _e( 'Email Address', 'buddypress' ) ?> <?php _e( '(required)', 'buddypress' ) ?></label>
                        <?php do_action( 'bp_signup_email_errors' ) ?>
                        <input type="text" name="signup_email" id="signup_email" value="<?php bp_signup_email_value() ?>" />
                        <small><i>Osoite, johon lähetetään käyttäjätilin luomisen varmennusviesti.</i></small>
