	...
	<?php else : ?>
        ...
        <?php if ( bp_get_signup_allowed() ) : ?>
			...
			<p id="login-text">
				...
				<?php printf( __( '<a href="%s" title="Luo tili">Luo käyttäjätili täältä</a> tai käytä PROksia Facebook-tililläsi yllä olevasta napista.', 'buddypress' ), site_url( bp_get_signup_slug() . '/' ) ) ?>
